...
st.set_page_config(page_title="Garment Classifier", page_icon="👕")
st.title("Garment Classifier 👕")
st.write("Upload a clothing photo and let the model find out what category it is!")
        ...
        with st.spinner("Model analyzing..."):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    st.success(f"This garment is a: **{predicted_class.title()}**")
                else:
